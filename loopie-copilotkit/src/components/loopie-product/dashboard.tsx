...
export function Dashboard() {
  ...
  return <>
    ...
    <section className="lp-section"><h2 className="lp-section-title">Recent runs</h2><RecordTable rows={runs.data.slice(0, 8)} columns={["id", "status", "mode", "kind", "ticket_id", "created_at"]} linkPrefixes={{id: "/runs/"}} /></section>
    <section className="lp-section"><h2 className="lp-section-title">Failure queue</h2><RecordTable rows={failures.data.slice(0, 8)} columns={["id", "status", "layer", "category", "external_id", "created_at"]} linkPrefixes={{id: "/failures/"}} /></section>
